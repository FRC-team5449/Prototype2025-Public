...
public class AutoAlignCommand extends Command {
  ...
  //       new LoggedTunableNumber("AutoAlign/controllerThetaTolerance",
  ...
  //       new LoggedTunableNumber("AutoAlign/maxLinearVelocity",
  // Drive.getMaxLinearSpeedMetersPerSec());
  //   private static final LoggedTunableNumber maxLinearAcceleration =
  //       new LoggedTunableNumber("AutoAlign/maxLinearAcceleration", Units.feetToMeters(75.0) *
  // 0.4);
